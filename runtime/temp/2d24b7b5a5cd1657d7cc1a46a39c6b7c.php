<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"F:\phpstudy\PHPTutorial\WWW\0301\tp0301/application/admin\view\product\productadd.html";i:1531313234;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="pro_name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">商品简介：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="pro_introduction">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="pro_number" id="" placeholder="" value="" class="input-text">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="pro_market" id="" placeholder="" value="" class="input-text">
				</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">销售价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="pro_price" id="" placeholder="" value="" class="input-text">
				</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">库存：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="pro_num" id="" placeholder="" value="" class="input-text">
				</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">图片主图：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="pro_picture[]" id="pro_picture" placeholder="" value="" class="input-text">
				</div>
		</div>
...
$(function(){
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: '__PUBLIC__lib/webuploader/0.1.5/Uploader.swf',
	
		// 文件接收服务端。
		server: '__PUBLIC__lib/webuploader/0.1.5/server/fileupload.php',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('__PUBLIC__lib/webuploader/0.1.5/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
