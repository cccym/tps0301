<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"F:\phpstudy\PHPTutorial\WWW\0301\tp0301/application/admin\view\category\categorylist.html";i:1531213335;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="f-14 product-brand-manage"><a style="text-decoration:none"  href="<?php echo url('Brand/brandUpdate',['id'=>$v['Id']]); ?>" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5"  href="<?php echo url('Brand/brandDelete',['id'=>$v['Id']]); ?>" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
